...
var _eventAbstractClass = require('event-abstract-class');

var _eventAbstractClass2 = _interopRequireDefault(_eventAbstractClass);
...
var BaseAction = function (_EventAbstractClass) {
    _inherits(BaseAction, _EventAbstractClass);
    ...
    function BaseAction(row) {
        var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

        _classCallCheck(this, BaseAction);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BaseAction).call(this));

        _this.row = row;
        _this.options = Object.assign({}, OPTIONS, options);
    ...
    _createClass(BaseAction, [{
        ...
        value: function handleButtonClick(evt) {
            this.click();
        }
    ...
    return BaseAction;
}(_eventAbstractClass2.default);

exports.default = BaseAction;
},{"event-abstract-class":15}],2:[function(require,module,exports){
'use strict';
...
var _BaseAction3 = _interopRequireDefault(_BaseAction2);
...
var ButtonAction = function (_BaseAction) {
  _inherits(ButtonAction, _BaseAction);
  ...
  function ButtonAction(row, options) {
    _classCallCheck(this, ButtonAction);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ButtonAction).call(this, row, options));
...
},{"./BaseAction":1}],3:[function(require,module,exports){
'use strict';
...
var LinkAction = function (_BaseAction) {
    _inherits(LinkAction, _BaseAction);
    ...
    function LinkAction(row, options) {
        _classCallCheck(this, LinkAction);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LinkAction).call(this, row, options));
    ...
    _createClass(LinkAction, [{
        ...
        value: function parseUrl() {
            ...
            this.options.url.match(expression).map(function (match) {
                url = _this2.options.url.replace(match, eval(match.replace(/([\${}]*)/g, '')));
            });
...
},{"./BaseAction":1}],4:[function(require,module,exports){
'use strict';
...
var BaseFilter = function (_EventAbstractClass) {
    _inherits(BaseFilter, _EventAbstractClass);
    ...
    function BaseFilter(meta) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BaseFilter).call(this));
    ...
    _createClass(BaseFilter, [{
        ...
        value: function handleInputKeyup(evt) {
            ...
            this.typingUpdateTimeout = window.setTimeout(function () {
        ...
        key: 'performToggleInput',
        value: function performToggleInput(isVisible) {
            if (isVisible) {
        ...
        key: 'performSetValue',
        value: function performSetValue(value) {
            this.value = value;
        ...
        key: 'toggleInput',
        value: function toggleInput(isVisible) {
...
},{"event-abstract-class":15}],5:[function(require,module,exports){
'use strict';
...
var CheckboxFilter = function (_BaseFilter) {
    ...
    function CheckboxFilter(meta) {
        var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

        _classCallCheck(this, CheckboxFilter);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CheckboxFilter).call(this, meta, options));
    ...
    _createClass(CheckboxFilter, [{
        ...
        value: function performRender() {
            ...
            _get(Object.getPrototypeOf(CheckboxFilter.prototype), 'performRender', this).call(this);
            ...
            options.map(function (option) {
                ...
                _this2.input.appendChild(optionNode);
            });
        }
...
},{"./BaseFilter":4}],6:[function(require,module,exports){
'use strict';
...
var SelectFilter = function (_BaseFilter) {
    _inherits(SelectFilter, _BaseFilter);
    ...
    function SelectFilter(meta) {
        var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

        _classCallCheck(this, SelectFilter);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SelectFilter).call(this, meta, options));
    ...
    _createClass(SelectFilter, [{
        ...
        value: function performRender() {
            ...
            _get(Object.getPrototypeOf(SelectFilter.prototype), 'performRender', this).call(this);

            emptyOption.value = '';
            emptyOption.innerHTML = this.options.emptyOptionText;
            this.input.appendChild(emptyOption);

            this.meta.options.map(function (option) {
                var optionNode = document.createElement('option');
...
},{"./BaseFilter":4}],7:[function(require,module,exports){
'use strict';
...
var TextFilter = function (_BaseFilter) {
    ...
    function TextFilter(meta) {
        var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

        _classCallCheck(this, TextFilter);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TextFilter).call(this, meta, options));
    ...
    _createClass(TextFilter, [{
        key: 'performRender',
        value: function performRender() {
            _get(Object.getPrototypeOf(TextFilter.prototype), 'performRender', this).call(this);
...
},{"./BaseFilter":4}],8:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.LinkAction = exports.ButtonAction = exports.BaseAction = exports.DateTimeRenderer = exports.CheckboxRenderer = exports.SelectRenderer = exports.NumberRenderer = exports.TextRenderer = exports.BaseRenderer = exports.CheckboxFilter = exports.SelectFilter = exports.TextFilter = exports.BaseFilter = undefined;
...
var _BaseFilter = require('./filters/BaseFilter');
...
var _NumberRenderer = require('./renderers/NumberRenderer');

var _NumberRenderer2 = _interopRequireDefault(_NumberRenderer);

var _SelectRenderer = require('./renderers/SelectRenderer');

var _SelectRenderer2 = _interopRequireDefault(_SelectRenderer);

var _CheckboxRenderer = require('./renderers/CheckboxRenderer');

var _CheckboxRenderer2 = _interopRequireDefault(_CheckboxRenderer);

var _DateTimeRenderer = require('./renderers/DateTimeRenderer');

var _DateTimeRenderer2 = _interopRequireDefault(_DateTimeRenderer);

var _BaseAction = require('./actions/BaseAction');

var _BaseAction2 = _interopRequireDefault(_BaseAction);

var _ButtonAction = require('./actions/ButtonAction');

var _ButtonAction2 = _interopRequireDefault(_ButtonAction);

var _LinkAction = require('./actions/LinkAction');

var _LinkAction2 = _interopRequireDefault(_LinkAction);
...
exports.BaseFilter = _BaseFilter2.default;
exports.TextFilter = _TextFilter2.default;
exports.SelectFilter = _SelectFilter2.default;
exports.CheckboxFilter = _CheckboxFilter2.default;
exports.BaseRenderer = _BaseRenderer2.default;
exports.TextRenderer = _TextRenderer2.default;
exports.NumberRenderer = _NumberRenderer2.default;
exports.SelectRenderer = _SelectRenderer2.default;
exports.CheckboxRenderer = _CheckboxRenderer2.default;
exports.DateTimeRenderer = _DateTimeRenderer2.default;
exports.BaseAction = _BaseAction2.default;
exports.ButtonAction = _ButtonAction2.default;
exports.LinkAction = _LinkAction2.default;
...
var OPTIONS = {
    ...
    select: _SelectFilter2.default,
    checkbox: _CheckboxFilter2.default
},
    RENDERERS = {
    text: _TextRenderer2.default,
    number: _NumberRenderer2.default,
    select: _SelectRenderer2.default,
    checkbox: _CheckboxRenderer2.default,
    datetime: _DateTimeRenderer2.default
},
    ACTIONS = {
    button: _ButtonAction2.default,
    link: _LinkAction2.default
};
...
var JSONMetaTable = function (_EventAbstractClass) {
    _inherits(JSONMetaTable, _EventAbstractClass);
    ...
    function JSONMetaTable(container) {
        var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
        ...
        var rendererTypes = arguments.length <= 5 || arguments[5] === undefined ? {} : arguments[5];
        var actionTypes = arguments.length <= 6 || arguments[6] === undefined ? {} : arguments[6];

        _classCallCheck(this, JSONMetaTable);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(JSONMetaTable).call(this));
        ...
        _this.filters = Object.assign({}, FILTERS, filterTypes);
        _this.renderers = Object.assign({}, RENDERERS, rendererTypes);
        _this.actionTypes = Object.assign({}, ACTIONS, actionTypes);

        _this.container = typeof container === 'string' ? document.querySelector(container) : container;

        if (_this.options.inlineDeleting) {
            _this.actions.push({
                name: 'delete',
                type: 'button',
                text: 'Delete',
                title: 'Delete this row',
                className: _this.options.deleteActionClass,
                event: _this.handleDeleteActionClick.bind(_this)
            });
        }
        return _this;
    }
    ...
    _createClass(JSONMetaTable, [{
        key: 'getMetaByColumnName',
        value: function getMetaByColumnName(columnName) {
        ...
        key: 'handleSortableHeadClick',
        value: function handleSortableHeadClick(meta, evt) {
            var direction = this.sorting.column === meta.name && this.sorting.direction === 'asc' ? 'desc' : 'asc';
        ...
        key: 'handleFilterPostSetValue',
        value: function handleFilterPostSetValue(meta) {
        ...
        key: 'handleRendererPostSetValue',
        value: function handleRendererPostSetValue(row, meta, renderer) {
        ...
        value: function handleDeleteActionClick(row) {
            this.deleteRow(row);
        }
        ...
        value: function renderHead() {
            ...
            this.metadata.map(function (meta) {
                ...
                meta.thContainer.className = _this2.options.thContainerClass;
                meta.thContainer.innerHTML = '<span>' + meta.label + '</span>';

                meta.th.appendChild(meta.thContainer);

                if (meta.info) {
                    meta.th.classList.add(_this2.options.hasInfoClass);
                    meta.th.title = meta.info;
                }

                if (meta.sortable) {
                    meta.th.classList.add(_this2.options.sortableClass);
                    meta.thContainer.addEventListener('click', _this2.handleSortableHeadClick.bind(_this2, meta));
                }

                if (meta.filterable && _this2.options.columnFiltering) {
                    meta.th.classList.add(_this2.options.filterableClass);

                    meta.th.appendChild(meta.filter.container);
                }

                _this2.theadRow.appendChild(meta.th);
            });
        ...
        value: function renderBody() {
            ...
            this.data.map(function (row) {
                ...
                _this3.metadata.map(function (meta) {
                    var displayValue = row.displayValues && row.displayValues[meta.name] ? row.displayValues[meta.name] : undefined;

                    row.cells[meta.name] = document.createElement('td');
                    row.renderers[meta.name] = new meta.renderer(_this3, meta, row.values[meta.name], displayValue);

                    row.renderers[meta.name].on('setValue:post', _this3.handleRendererPostSetValue.bind(_this3, row, meta, row.renderers[meta.name]));

                    row.cells[meta.name].appendChild(row.renderers[meta.name].container);
                    row.tr.appendChild(row.cells[meta.name]);
                });

                if (_this3.actions.length > 0) {
                    (function () {
                        ...
                        actionsContainer.className = _this3.options.actionsContainerClass;

                        _this3.actions.map(function (action) {
                            row.actions[action.name] = new _this3.actionTypes[action.type](row, action);
                ...
                _this3.tbody.appendChild(row.tr);
            });
        ...
        value: function setMetadata(metadata) {
            ...
            this.metadata.map(function (meta, index) {
                _this4.metadata[index] = Object.assign({}, METADATA, meta);

                if (!_this4.metadata[index].renderer) {
                    _this4.metadata[index].renderer = _this4.renderers[_this4.metadata[index].type] ? _this4.renderers[_this4.metadata[index].type] : _this4.renderers.text;
                }

                if (_this4.options.columnFiltering && _this4.metadata[index].filterable && !_this4.metadata[index].filter) {
                    _this4.metadata[index].filter = _this4.filters[_this4.metadata[index].type] ? new _this4.filters[_this4.metadata[index].type](meta, _this4.filterOptions) : new _this4.filters.text(meta, _this4.filterOptions);

                    if (_this4.filtering[meta.name]) {
                        _this4.metadata[index].filter.setValue(_this4.filtering[meta.name]);
                    }

                    _this4.metadata[index].filter.on('setValue:post', _this4.handleFilterPostSetValue.bind(_this4, _this4.metadata[index]));
                }
            });
        ...
        value: function sortBy(column) {
            ...
            newData.sort(function (a, b) {
                var result = a.values[column] < b.values[column] ? -1 : a.values[column] > b.values[column] ? 1 : 0;
            ...
            try {
                for (var _iterator = this.metadata[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        key: 'filterByColumns',
        value: function filterByColumns(values) {
            var _this5 = this;
            ...
            this.data = this.completeData.filter(function (row) {
                var matches = 0;
                ...
                try {
                    for (var _iterator3 = columns[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        ...
                        var textSearch = new String(_this5.filtering[column]).toLowerCase(),
                            meta = _this5.getMetaByColumnName(column);
                        ...
                        if (meta.options && row.values[column] === _this5.filtering[column]) {
                            matches += 1;
        ...
        key: 'filterBy',
        value: function filterBy(column, search) {
        ...
        value: function filter(search) {
            ...
            var textSearch = new String(search).toLowerCase();
            ...
            this.data = this.completeData.filter(function (row) {
                ...
                try {
                    var _loop = function _loop() {
                        ...
                        var isOptionMatching = false,
                            isValueMatching = new String(row.values[meta.name]).toLowerCase().indexOf(textSearch) >= 0;

                        if (meta.options) {
                            isOptionMatching = meta.options.find(function (option) {
                                return option.value === row.values[meta.name] && option.label.toLowerCase().indexOf(textSearch) >= 0;
                            }) !== undefined;
                        }
                    ...
                    _loop2: for (var _iterator4 = _this6.metadata[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                        var _ret2 = _loop();
        ...
        value: function deleteRow(row) {
            var id = row.id ? row.id : row;

            this.trigger('deleteRow:pre', {
                id: id
            });

            var data = this.completeData.filter(function (item) {
                return item.id !== id;
            });
    ...
    return JSONMetaTable;
}(_eventAbstractClass2.default);

exports.default = JSONMetaTable;
},{"./actions/BaseAction":1,"./actions/ButtonAction":2,"./actions/LinkAction":3,"./filters/BaseFilter":4,"./filters/CheckboxFilter":5,"./filters/SelectFilter":6,"./filters/TextFilter":7,"./renderers/BaseRenderer":9,"./renderers/CheckboxRenderer":10,"./renderers/DateTimeRenderer":11,"./renderers/NumberRenderer":12,"./renderers/SelectRenderer":13,"./renderers/TextRenderer":14,"event-abstract-class":15}],9:[function(require,module,exports){
'use strict';
...
var BaseRenderer = function (_EventAbstractClass) {
    _inherits(BaseRenderer, _EventAbstractClass);
    ...
    function BaseRenderer(table, meta, value, displayValue) {
        _classCallCheck(this, BaseRenderer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BaseRenderer).call(this));
        ...
        _this.initialDisplayValue = displayValue;
        ...
        _this.inputBlurHandler = _this.handleInputBlur.bind(_this);
        return _this;
    }
    ...
    _createClass(BaseRenderer, [{
        ...
        key: 'unbindInputBlur',
        value: function unbindInputBlur() {
        ...
        value: function handleDisplayClick(evt) {
            this.focus();
        }
        ...
        key: 'performToggleEditor',
        value: function performToggleEditor(isEditing) {
            if (isEditing) {
        ...
        key: 'performSetValue',
        value: function performSetValue(value) {
            var displayValue = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
        ...
        key: 'toggleEditor',
        value: function toggleEditor(isVisible) {
...
},{"event-abstract-class":15}],10:[function(require,module,exports){
'use strict';
...
var CheckboxRenderer = function (_BaseRenderer) {
    _inherits(CheckboxRenderer, _BaseRenderer);
    ...
    function CheckboxRenderer(table, meta, value, displayValue) {
        _classCallCheck(this, CheckboxRenderer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CheckboxRenderer).call(this, table, meta, value, displayValue));

        _this.init();

        _this.bindInputClick();
        return _this;
    }
    ...
    _createClass(CheckboxRenderer, [{
        ...
        key: 'performRender',
        value: function performRender() {
            _get(Object.getPrototypeOf(CheckboxRenderer.prototype), 'performRender', this).call(this);
...
},{"./BaseRenderer":9}],11:[function(require,module,exports){
'use strict';
...
var DateTimeRenderer = function (_BaseRenderer) {
    _inherits(DateTimeRenderer, _BaseRenderer);
    ...
    function DateTimeRenderer(table, meta, value, displayValue) {
        _classCallCheck(this, DateTimeRenderer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DateTimeRenderer).call(this, table, meta, value, displayValue));
    ...
    _createClass(DateTimeRenderer, [{
        key: 'parseValue',
        value: function parseValue(value) {
            var date = (0, _moment2.default)(new Date(value));

            return date.isValid() ? date.format() : this.initialValue;
        }
        ...
        key: 'performRender',
        value: function performRender() {
            _get(Object.getPrototypeOf(DateTimeRenderer.prototype), 'performRender', this).call(this);
...
exports.default = DateTimeRenderer;
},{"./BaseRenderer":9,"moment":16}],12:[function(require,module,exports){
'use strict';
...
var NumberRenderer = function (_BaseRenderer) {
    _inherits(NumberRenderer, _BaseRenderer);
    ...
    function NumberRenderer(table, meta, value, displayValue) {
        _classCallCheck(this, NumberRenderer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NumberRenderer).call(this, table, meta, value, displayValue));
    ...
    _createClass(NumberRenderer, [{
        ...
        key: 'performRender',
        value: function performRender() {
            _get(Object.getPrototypeOf(NumberRenderer.prototype), 'performRender', this).call(this);
...
exports.default = NumberRenderer;
},{"./BaseRenderer":9}],13:[function(require,module,exports){
'use strict';
...
var SelectRenderer = function (_BaseRenderer) {
    _inherits(SelectRenderer, _BaseRenderer);
    ...
    function SelectRenderer(table, meta, value, displayValue) {
        _classCallCheck(this, SelectRenderer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SelectRenderer).call(this, table, meta, value, displayValue));
    ...
    _createClass(SelectRenderer, [{
        ...
        value: function formatValue(value) {
            ...
            option = this.meta.options.find(function (option) {
        ...
        value: function performRender() {
            ...
            _get(Object.getPrototypeOf(SelectRenderer.prototype), 'performRender', this).call(this);
...
},{"./BaseRenderer":9}],14:[function(require,module,exports){
'use strict';
...
var TextRenderer = function (_BaseRenderer) {
    ...
    function TextRenderer(table, meta, value, displayValue) {
        _classCallCheck(this, TextRenderer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TextRenderer).call(this, table, meta, value, displayValue));
    ...
    _createClass(TextRenderer, [{
        key: 'performRender',
        value: function performRender() {
            _get(Object.getPrototypeOf(TextRenderer.prototype), 'performRender', this).call(this);
...
},{"./BaseRenderer":9}],15:[function(require,module,exports){
'use strict';
...
var EventAbstractClass = function () {
    // region Constructor
    ...
    function EventAbstractClass() {
        _classCallCheck(this, EventAbstractClass);
    ...
    _createClass(EventAbstractClass, [{
        key: 'getEventList',
        value: function getEventList(events) {
        ...
        key: 'getNamespaces',
        value: function getNamespaces(event) {
            var namespaces = [],
                splitEvent = event.trim().split(/:+/g);

            for (var i = splitEvent.length; i >= 1; i -= 1) {
        ...
        value: function trigger(eventName) {
            ...
            var events = this.getEventList(eventName);
            ...
            try {
                for (var _iterator = events[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    var namespaces = this.getNamespaces(event);
                    ...
                    try {
                        for (var _iterator2 = namespaces[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            ...
                            try {
                                for (var _iterator3 = this.events[namespace][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    return EventAbstractClass;
}();

exports.default = EventAbstractClass;
